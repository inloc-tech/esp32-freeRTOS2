...
- [/settings/get] (#settings_get_)
- [/settings/update] (#settings_update_)
- [/settings/wifi/set] (#settings_wifi_)
- [/settings/wifi/get] (#settings_wifi_get_)
- [/settings/modem/set] (#settings_modem_)
- [/settings/modem/get] (#settings_modem_get_)
- [/settings/mqtt/set] (#settings_mqtt_)
- [/settings/mqtt/get] (#settings_mqtt_get_)
- [/settings/log/set] (#settings_log_)
- [/settings/log/get] (#settings_log_get_)
- [/settings/keepalive/set] (#settings_keepalive_)
- [/settings/keepalive/get] (#settings_keepalive_get_)
- [/settings/serial/set] (#settings_serial_)
- [/settings/serial/get] (#settings_serial_get_)
- [/fw/ar/set] (#fw_ar_)
- [/fw/ar/get] (#fw_ar_get_)
- [/fw/alarms/set] (#fw_alarm_)
- [/fw/alarms/get] (#fw_alarm_get_)
